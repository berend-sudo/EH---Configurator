...
function FinalScreen({ initialPlans }: { initialPlans: FloorPlanEntry[] }) {
...
export default function SummaryClient({ initialPlans }: { initialPlans: FloorPlanEntry[] }) {
  return (
    <Suspense fallback={null}>
      <FinalScreen initialPlans={initialPlans} />
    </Suspense>
  );
}
