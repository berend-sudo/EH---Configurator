...
import type { FloorplanJSON } from "@/types/dxfFloorplan";
import FloorplanSVG from "@/components/DxfFloorplanSVG";

export default function DxfConfigurator() {
        ...
        {!plan && (
          ...
          >
            ...
            <p className="text-stone-400 text-xs mt-3">
              ...
              PT Top Right, PT Top Left, PT Top Left Furniture, PT Top Right Furniture
            </p>
          </div>
        )}
